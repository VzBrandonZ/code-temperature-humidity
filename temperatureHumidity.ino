...
const char* ssid = “xxxx”; //Usuario red WIFI.
const char* password = “xxxx”; //Contraseña WIFI.
...
void loop()
{
 ...
 GetSensor(); // se adquiere y publica en el broker los datos adquiridos por el sensor cada
segundo.
 CrearJson();
 PublicarMensaje();
